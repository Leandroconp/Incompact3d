program visu_paraview
  ...
  integer(4) :: nfiles, icrfile, file1, filen, ifile, dig1, dig2, dig3, dig4, dig5, dig6, dig7
...
!  character(4) :: chits
!IF THE DATA ARE STORED WITH 7 DIGITS, IE UX0001,UX0002,ETC.
!  character(7) :: chits

  write (*,*) 'itime,nz,    - Incompact3D'
  read (*,*) nx, ny
  nz=1
  write (*,*) 'time,Lz   - Incompact3D'
  read (*,*) xlx, yly 
  zlz = 1.
...
!     write(nfil,*)'            <Attribute Name="u" Center="Node">'
...
!     write(nfil,*)'            </Attribute>'
!
!     write(nfil,*)'            <Attribute Name="ul" Center="Node">'
!     write(nfil,*)'               <DataItem Format="Binary" '
!     write(nfil,*)'                DataType="Float" Precision="4" Endian="little"'
!     write(nfil,*)'                Dimensions="',nz,ny,nx,'">'
!     write(nfil,*)'                  ul'
...
!     write(nfil,*)'            </Attribute>'
!
!     write(nfil,*)'            <Attribute Name="vl" Center="Node">'
!     write(nfil,*)'               <DataItem Format="Binary" '
!     write(nfil,*)'                DataType="Float" Precision="4" Endian="little"'
!     write(nfil,*)'                Dimensions="',nz,ny,nx,'">'
!     write(nfil,*)'                  vl'
...
!     write(nfil,*)'            </Attribute>'
     ...
     write(nfil,*)'            <Attribute Name="Ruutime" Center="Node">'
     write(nfil,*)'               <DataItem Format="Binary" '
     write(nfil,*)'                DataType="Float" Precision="4" Endian="little"'
     write(nfil,*)'                Dimensions="',nz,ny,nx,'">'
     write(nfil,*)'                  Ruutime'
     ...
     write(nfil,*)'            </Attribute>'
!   
!     write(nfil,*)'            <Attribute Name="Rvvtime" Center="Node">'
!     write(nfil,*)'               <DataItem Format="Binary" '
!     write(nfil,*)'                DataType="Float" Precision="4" Endian="little"'
!     write(nfil,*)'                Dimensions="',nz,ny,nx,'">'
!     write(nfil,*)'                  Rvvtime'
